# Generated by Powerlevel10k configuration wizard on 2024-06-26 at 16:29 IST.
...
# 2 lines, disconnected, full frame, light-ornaments, sparse, many icons, fluent,
...
() {
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=120
